...
export const metadata = {
  title: `S1 Teknik Sipil | ${siteConfig.name} ${siteConfig.university}`,
  description:
    "Informasi lengkap Program Studi S1 Teknik Sipil Fakultas Teknik Universitas Palembang. Akreditasi Baik Sekali BAN-PT, Visi Misi, Kurikulum OBE, Lab Terpadu, dan Prospek Karir.",
};

export default function TeknikSipilPage() {
  const prodi = prodiDetailData["teknik-sipil"];
      ...
      <section className="relative w-full flex items-center justify-center min-h-[260px] sm:min-h-[300px] lg:min-h-[340px] overflow-hidden bg-slate-950 text-white pt-20 pb-12 sm:pt-24 sm:pb-14 lg:pt-28 lg:pb-16">
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center space-y-3 pt-2">
          ...
          <p className="text-slate-200 text-sm sm:text-base max-w-3xl mx-auto font-light leading-relaxed">
            Perancangan infrastruktur modern, rekayasa struktur bangunan tinggi, geoteknik, manajemen proyek konstruksi, dan teknologi keairan terpadu.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-8 space-y-4">
              <div className="border-b border-stone-200/60 pb-3">
                <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1B3A5C]">
                  Tentang Program Studi Teknik Sipil
                </h2>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <GlassCard innerClassName="p-4 sm:p-6 lg:p-8">
          <FeatureSteps
            ...
            title="Bidang yang Dipelajari di Teknik Sipil"
            subtitle="Kompetensi dan ruang lingkup keilmuan mendalam yang akan dipelajari selama masa studi di S1 Teknik Sipil UNPAL."
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
        <GlassCard>
          <div className="space-y-6">
            <div className="border-b border-stone-200/60 pb-3">
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1B3A5C]">
                Prospek Karir Lulusan Teknik Sipil
              </h2>
            </div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-[#112236] text-white p-8 sm:p-12 shadow-2xl border border-amber-500/20">
          ...
          <div className="relative z-10 text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight">
              Daftar S1 Teknik Sipil FT UNPAL
            </h2>

            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Bergabunglah menjadi bagian dari lulusan unggul Teknik Sipil yang siap membangun infrastruktur Indonesia.
            </p>
