...
const footerSections: FooterData[] = [
  {
    ...
    links: [
      { title: "Beranda", href: "/" },
      { title: "Profil Fakultas", href: "/profil" },
      { title: "Civitas Akademika", href: "/civitas" },
      { title: "Pendaftaran PMB", href: "/pmb" },
      { title: "Galeri Foto", href: "/galeri" },
      { title: "Publikasi Jurnal", href: "/publikasi" },
    ],
  },
  {
    title: "Program Studi & Portal",
    links: [
      { title: "S1 Teknik Sipil", href: "/profil" },
      { title: "S1 Teknik Elektro", href: "/profil" },
      { title: "Portal Mahasiswa", href: "https://portal.universitas-palembang.ac.id" },
      { title: "Sistem E-Learning", href: "https://elearning.universitas-palembang.ac.id" },
      { title: "Perpustakaan Digital", href: "https://lib.universitas-palembang.ac.id" },
    ],
  },
];
...
const Footer = () => {
  return (
    <footer className="py-10 bg-[#112236] text-slate-200 border-t border-amber-500/20">
      <div className="max-w-[115rem] xl:px-20 lg:px-12 px-6 mx-auto">
        <div className="flex flex-col gap-6 sm:gap-12">
                  ...
                  <ul className="flex flex-col gap-3">
                    {links.map(({ title, href }) => (
                      <li key={title}>
                        <a
                          href={href}
                          className="text-base font-normal text-slate-300 hover:text-amber-400 transition-colors"
                        >
                          {title}
                        </a>
                      </li>
          ...
          <p className="text-sm font-normal text-slate-400 text-center animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-100 ease-in-out fill-mode-both">
            ©{new Date().getFullYear()} {siteConfig.name} {siteConfig.university}. All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
